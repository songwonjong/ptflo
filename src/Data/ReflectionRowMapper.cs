...
namespace Microsoft.Practices.EnterpriseLibrary.Data
{
    ...
    public abstract class PropertyMapping
    {
        ...
        /// <returns></returns>
        public static Type GetConvertType(Type type)
        {
            return (PropertyMapping.IsNullableType(type) ? (new NullableConverter(type)).UnderlyingType : type);
        }
        ...
        {
            object obj;
            if (PropertyMapping.ValidateValue(value))
            {
                try
                {
                    obj = Convert.ChangeType(value, PropertyMapping.GetConvertType(type));
                }
        ...
        {
            return (value == null ? false : value != DBNull.Value);
        }
    }
