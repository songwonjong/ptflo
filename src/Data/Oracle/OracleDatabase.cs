...
namespace Microsoft.Practices.EnterpriseLibrary.Data.Oracle
{
    ...
    public class OracleDatabase : Database
    {
        ...
        public OracleDatabase(string connectionString, ISqlCache sqlCache, ILogger logger)
            : this(connectionString, emptyPackages, sqlCache, logger)
        {
        }
...
#pragma warning disable 612, 618
        public OracleDatabase(string connectionString, IEnumerable<IOraclePackage> packages, ISqlCache sqlCache, ILogger logger)
            : base(connectionString, OracleClientFactory.Instance, sqlCache, logger)
        {
