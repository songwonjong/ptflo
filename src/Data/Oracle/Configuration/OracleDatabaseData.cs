...
namespace Microsoft.Practices.EnterpriseLibrary.Data.Oracle.Configuration
{
    ...
    public class OracleDatabaseData : DatabaseData
    {
        ...
        public OracleDatabaseData(ConnectionStringSettings connectionStringSettings, Func<string, ConfigurationSection> configurationSource, ISqlCache sqlCache, ILogger logger)
...
#pragma warning disable 612, 618
            return new OracleDatabase(this.ConnectionString, this.PackageMappings.Cast<IOraclePackage>().ToArray(), this._sqlCache, this._logger);
