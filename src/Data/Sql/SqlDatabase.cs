...
namespace Microsoft.Practices.EnterpriseLibrary.Data.Sql
{
    ...
    public partial class SqlDatabase : Database
    {
        ...
        public SqlDatabase(string connectionString, ISqlCache sqlCache, ILogger logger)
            : base(connectionString, SqlClientFactory.Instance, sqlCache, logger)
        {
        }
        ...
        protected override int UserParametersStartIndex(DbCommand command)
        {
            return 1;
        }
